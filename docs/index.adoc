...
* link:../src/main/java/com/nhnacademy/http/channel/HttpRequestImpl.java[HttpRequestImpl]  구현 합니다.

[source,java]
--
include::../src/main/java/com/nhnacademy/http/channel/HttpRequest.java[]
--
